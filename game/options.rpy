...
define config.name = "DDLC Reprogrammed"
...
define build.name = "DDLCReprogrammed"
...
define config.save_directory = "DDLC_Reprogrammed"
...
init python:
    ...
    build.classify('Discord.html',build.name)
