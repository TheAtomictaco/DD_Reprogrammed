...
label beginning_monika:
    ...
    m "..."
    m "Why are you back?"
    m "You think that this world has happiness?"
    m "No it does not."
    m "..."
    m "You are not going to leave, are you?"
    m ".."
    m "I have a idea, just a minute!"
    call updateconsole ("os.install(\"game\mod-installer.rpyc\")", "choices installed successfully.") from _call_updateconsole_15
...
label ch30_endb:
    ...
    pause 3.0
    call updateconsole ("renpy.file(\"characters/monika.chr\")", "monika.chr does not exist.") from _call_updateconsole_18
    call updateconsole ("renpy.file(\"characters/monika.chr\")", "monika.chr does not exist.") from _call_updateconsole_19
